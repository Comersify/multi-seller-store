export const ProductDetailsCard = () => {
  return (
    <div class="mx-auto w-90 px-4 pb-16 pt-10 col-span-2 lg:col-span-3 sm:px-6 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
